    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <ScrollView>
                ...
                <TouchableOpacity
                    style={styles.button}
                    onPress={handleRentACar}
                >
                    <Text style={styles.buttonText}>Rent a Car</Text>
                </TouchableOpacity>

                <Text style={styles.sellWorkText}>How AutoFinder Rent a Car Service Works?</Text>
                <WorksellForItForMe imageSource={require('../assets/number-1.png')} text="Sign Up for Rent a Car Services." />
                <WorksellForItForMe imageSource={require('../assets/number-2.png')} text="Providing details about vehicle you want to rent." />
                <WorksellForItForMe imageSource={require('../assets/number-3.png')} text="Your rent a car ad will be displayed in rent section." />
                <WorksellForItForMe imageSource={require('../assets/number-3.png')} text="Interested customers will contact you as soon as possible." />

                {/* <Text style={styles.sellWorkText}>Advantage</Text> */}
                {/* <Text style={styles.NoteText}>Easy Booking Process</Text> */}

                <Advantage advantages={['Easy Booking Process', 'Tranparent Pricing', 'Hassle-Free Service']} />
