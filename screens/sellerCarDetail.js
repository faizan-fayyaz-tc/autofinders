        ...
        return (
            ...
            <View style={styles.header}>
                ...
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>AutoFinders</Text>
                </View>
            </View>
            <ScrollView>
    ...
    <View style={styles.navigationContainer}>
        ...
        <TouchableOpacity onPress={handleNextImage} style={styles.navigationButton}>
            ...
            />
                ...
                <Text style={styles.locationText}>{carLocation}</Text>
            ...
            add Auction report */}
                ...
                <TouchableOpacity onPress={handleSellerDetailsPress} style={styles.sellerDetailButton}>
