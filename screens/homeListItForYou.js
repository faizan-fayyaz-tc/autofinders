    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <ScrollView>
                ...
                <Text style={styles.addTextChoose}>Why AutoFinder is best for List It For You?</Text>
                <FeatureLine imageSource={require('../assets/reports.png')} text="Tension Free Service" />
                <FeatureLine imageSource={require('../assets/staff.png')} text="Professional Sales Executive" />
                <FeatureLine imageSource={require('../assets/inspection.png')} text="Your Car Your Price" />
                <FeatureLine imageSource={require('../assets/inspection.png')} text="Peaceful Transaction of your money" />

                <Text style={styles.sellWorkText}>How this will happen?</Text>
                <WorksellForItForMe imageSource={require('../assets/number-1.png')} text="Sign Up for List it for you service" />
                <WorksellForItForMe imageSource={require('../assets/number-2.png')} text="Book a time and location for the listing service" />
                <WorksellForItForMe imageSource={require('../assets/number-3.png')} text="Team of Experts will visit the vehicle owner and conduct the inpections and create a car listing on your behalf" />
                <WorksellForItForMe imageSource={require('../assets/number-3.png')} text="Your advertisement is prominently and promoted throughout the AutoFinder's website mobile app" />
                ...
                <Text style={styles.summaryText}>Our premium service includes professional photo capture, detailed inspections, and listing creation on Autofinder's platform. We handle all inquiries, manage offers, and negotiate deals on your behalf. With us, you're guaranteed a secure payment transfer after finalizing the deal. Sell hassle-free with Autofinder.</Text>
