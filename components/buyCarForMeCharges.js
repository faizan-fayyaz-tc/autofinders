        ...
        >
            <View style={styles.modalContainer}>
                <View style={styles.modalContent}>
                    ...
                    <Text style={styles.text}>Will be charged after purchase of your car.</Text>
                    <Text style={styles.heading}>Note:</Text>
                    <Text style={styles.text}>
                        Once you have agreed to the eligibility, and made a payment, a refund request will not be entertained.
                    </Text>
